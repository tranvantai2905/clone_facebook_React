  ...
  return (
    <div className="fixed bottom-0 right-10">
      <Card className={cn("w-[350px]")}>
        ...
        <CardContent className="grid max-h-[400px] gap-4 overflow-scroll pt-5">
          <div className="mb-5 flex w-full flex-col items-end">
            <div className="flex w-4/5 justify-end space-y-1 rounded-full rounded-tr-none text-right">
              <p className="w-fit rounded-full rounded-tr-none bg-blue-500 p-3 pl-5 pr-5 text-sm font-medium leading-none text-white">
                {"I love you <36"}
              </p>
            </div>
          ...
          <div className="mb-5 flex w-full flex-col items-end">
            <div className="flex w-4/5 justify-end space-y-1 text-right">
              <p className="rounded-full rounded-tr-none bg-blue-500 p-2 pl-5 pr-5 text-sm font-medium leading-5 text-white">
                {"I love you <36"}
              </p>
            </div>
            <div className="mt-2 self-center">
          ...
          <div className="mb-5 flex w-full flex-col items-start">
            <div className="flex w-4/5 justify-start space-y-1 text-left">
              <p className="rounded-full rounded-tl-none bg-blue-500 p-2 pl-5 pr-5 text-sm font-medium leading-5 text-white">
                {"I love you, too <36"}
              </p>
            </div>
            <div className="mt-2 self-center">
